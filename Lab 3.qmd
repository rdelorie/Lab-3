...
```{r}
#values aligned to the left or right
...
#Hint: You will need two group_by calls and the zoo:: rollmean
233
234
235
236
...
filter(state %in% ('New York', "Ohio", 'Colorado', "Alabama"))
%>%
237
238
239
...
roll = z0o::rollmean(newCases, k = 7, align = "right", fill = zoo::rollmean(newCases, k = 7, align = "right", fill = NA)) %>% 
  ungroup()
```
